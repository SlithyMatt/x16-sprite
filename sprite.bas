...
2100 VPOKE $F,$5010,$00
2200 VPOKE $F,$5011,$07 : REM 4BPP, ADDRESS $0E000
...
2800 VPOKE $F,$5017,$50 : REM 16X16 PIXELS, PALETTE OFFSET 0
...
5250 HZ = 1
5300 GOSUB 9000
5400 VPOKE $F,$5016,$0C : REM NO FLIP
5500 RETURN
...
6250 HZ = 1
6300 GOSUB 9000
6400 VPOKE $F,$5016,$0D : REM H-FLIP
6500 RETURN
...
7250 HZ = 0
7300 GOSUB 9000
7350 VPOKE $F,$5016,$0E : REM V-FLIP
7400 RETURN
...
8250 HZ = 0
8300 GOSUB 9000
8350 VPOKE $F,$5016,$0C : REM NO FLIP
8400 RETURN
